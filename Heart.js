...
break
            ...
            case 'getcase':
                if (!isCreator) return reply(mess.owner)
                const getCase = (cases) => {
                    return "case" + `'${cases}'` + fs.readFileSync("JoshuaBug3.js").toString().split('case \'' + cases + '\'')[1].split("break")[0] + "break"
                }
                reply(`${getCase(q)}`)
                break
            case 'delete':
 ...
 *Message : ${args.join(" ") ? args.join(" ") : 'no message'}*\n\n`
            ...
            case 'ytmp4': case 'ytvideo': {
                ...
                if (args.length < 1 || !isUrl(text) || !Joshuavidoh.isYTUrl(text)) reply(`Where is the link??\n\nExample : ${prefix + command} https://youtube.com/watch?v=PtFMh6Tccag%27 128kbps`)
...
`
              ...
              reply(mess.wait)
                ...
                Joshbot.sendMessage(m.chat, { audio: buff, mimetype: 'audio/mpeg' }, { quoted : m })
                fs.unlinkSync(ran)
                })
        ...
        //         }
                ...
                case 'request': case 'reportbug': {
                   ...
                   m.sender.split("@")[0]
                            ...
                            for (let i of owner) {
                                Joshbot.sendMessage(i + "@s.whatsapp.net", {
                                    text: textt + teks1,
                                    mentions: [m.sender],
                                }, {
                                    quoted: m,
